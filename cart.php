        ...
        <form method="POST" action="completeBooking.php">
            <div class="row">
                <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3 mb-md-0">
                                <img src="tripsorus-admin/<?php echo htmlspecialchars($bookingDetails['property_image']); ?>"
                                    ...
                                    alt="<?php echo htmlspecialchars($bookingDetails['property_name']); ?>">
                            </div>
                            <div class="col-md-8">
                                <h4>
                                ...
                                <div class="mt-3">
                                    ...
                                    <p>
                                        ...
                                        <span class="meal-plan-badge"
                                            title="<?php echo htmlspecialchars($bookingDetails['meal_name']); ?>">
                        ...
                        <div id="gstFields" style="display:none;">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="gstCompanyAddress"
                    ...
                    <div class="booking-card">
                        ...
                        <!-- Pay at Property -->
                        <div class="payment-method" data-method="pay_at_property"
                            onclick="selectPayment('pay_at_property')">
                        ...
                        <div class="payment-method active" data-method="credit_card"
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="payment_type" id="creditCard"
                        ...
                        <div class="payment-method" data-method="net_banking" onclick="selectPayment('net_banking')">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="payment_type" id="netBanking"
                                    value="net_banking">
           ...
           <input type="hidden" name="meal_type" value="<?php echo htmlspecialchars($bookingDetails['meal_name']); ?>">
            <input type="hidden" name="check_in"
                value="<?php echo htmlspecialchars($bookingDetails['checkin_date']); ?>">
            <input type="hidden" name="check_out"
                value="<?php echo htmlspecialchars($bookingDetails['checkout_date']); ?>">
    ...
    <script>
        ...
        function displayVouchers() {
            ...
            availableVouchers.forEach(v => {
                ...
                btn.textContent = v.code + (v.discount_type === 'percentage' ? ` (${v.discount_value}%)` : ` (₹${v.discount_value})`);
        ...
        function applyVoucher(code = null) {
            ...
            if (code) {
                ...
                coupon = availableVouchers
                    ...
                    .sort((a, b) => {
                        const aAmount = a.discount_type === 'percentage' ? originalTotal * (a.discount_value / 100) : a.discount_value;
                        const bAmount = b.discount_type === 'percentage' ? originalTotal * (b.discount_value / 100) : b.discount_value;
            ...
            let discount = 0;
            if (coupon) {
                discount = coupon.discount_type === 'percentage' ? Math.round(originalTotal * (coupon.discount_value / 100)) : coupon.discount_value;
            }
