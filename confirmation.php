...
<body>
    ...
    <section class="confirmation-hero text-center py-5 bg-dark text-white">
        <div class="container">
            ...
            <div class="booking-ref mb-3">Booking Reference: <strong><?php echo htmlspecialchars($bookingRef); ?></strong></div>
            <p>We've sent a confirmation email to <strong><?php echo htmlspecialchars($booking['email'] ?? 'Not provided'); ?></strong></p>
            <div class="mt-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="confirmation-card mb-4 p-4 border rounded shadow-sm">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <img src="<?php echo htmlspecialchars($hotelImage); ?>" 
                ...
                <div class="confirmation-card mb-4 p-4 border rounded shadow-sm">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-3"><i class="fas fa-envelope me-2"></i> Confirmation Email sent to <?php echo htmlspecialchars($booking['email'] ?? 'you'); ?></li>
                        <li class="mb-3"><i class="fas fa-bed me-2"></i> Present booking reference at check-in</li>
                        <li><i class="fas fa-umbrella-beach me-2"></i> Enjoy your stay at <?php echo htmlspecialchars($booking['property_name']); ?></li>
                    </ul>
                </div>
            </div>
