...
if (isset($_SESSION['user_id'])) {
    header("Location: registration-success.php?user_type=" . $_SESSION['user_type']);
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        echo "<script>alert('Signup successful!'); window.location.href = 'registration-success.php?user_type=$user_type';</script>";
        exit;
