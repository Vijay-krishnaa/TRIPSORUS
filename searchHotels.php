            ...
            <form action="searchHotels.php" method="GET">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                        ...
                        <input type="text" id="locationDisplay" name="location_display" class="form-control" placeholder="City, Hotel, or Area"
                    ...
                    <div class="col-md-6 col-lg-1 d-flex align-items-end">
                        <button type="submit" class="btn btn-primary w-100 s-btn">Search</button>
                    </div>
                </div>
            </form>
        </div>
  ...
  <?php if (count($results) > 0): ?>
    <?php foreach ($results as $property): ?>
      <div class="card hotel-card mb-4 property-item"
           data-price="<?php echo isset($property['price']) ? $property['price'] : 0; ?>"
           data-rating="4"
           data-amenities="<?php echo htmlspecialchars($property['amenities']); ?>"
           data-beds="Queen,Double">

        <div class="row g-0">
          <!-- Image -->
          <div class="col-md-4">
            <div class="image-box">
              <img src="tripsorus-admin/<?php echo htmlspecialchars($property['image']); ?>"
                   class="img-fluid"
