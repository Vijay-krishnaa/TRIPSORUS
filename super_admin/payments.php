            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <?php foreach ($payments as $payment): 
                    $statusClass = '';
                    if ($payment['status'] == 'Confirmed') $statusClass = 'bg-success';
                    else if ($payment['status'] == 'Pending') $statusClass = 'bg-warning text-dark';
                    else if ($payment['status'] == 'Cancelled') $statusClass = 'bg-danger';
                    ...
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Payment Details -
                          <?php echo htmlspecialchars($payment['booking_code']); ?></h5>
                          ...
                          <div class="mb-3">
                            ...
                            <select class="form-select" id="status" name="status" required>
                              <option value="Confirmed"
                                <?php echo $payment['status'] === 'Confirmed' ? 'selected' : ''; ?>>Confirmed</option>
                              <option value="Pending" <?php echo $payment['status'] === 'Pending' ? 'selected' : ''; ?>>
                                Pending</option>
                              <option value="Cancelled"
                                <?php echo $payment['status'] === 'Cancelled' ? 'selected' : ''; ?>>Cancelled</option>
                            </select>
                          </div>
                        </div>
                        <div class="modal-footer">
