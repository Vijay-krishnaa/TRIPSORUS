  ...
  <div class="main-content">
    <div class="container-fluid">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <br>
        <br>
        <h2>Dashboard Overview <span class="admin-id-badge">Admin ID: <?php echo safeOutput($adminId); ?></span></h2>
        <div class="d-flex">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="stats-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
            ...
            <div class="count"><?php echo safeOutput($totalProperties); ?></div>
        ...
        <div class="col-md-3">
          <div class="stats-card" style="background: linear-gradient(135deg, #ff758c 0%, #ff7eb3 100%);">
            ...
            <div class="count"><?php echo safeOutput($totalBookings); ?></div>
        ...
        <div class="col-md-3">
          <div class="stats-card" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
            ...
            <div class="count"><?php echo safeOutput($activeGuests); ?></div>
        ...
        <div class="col-md-3">
          <div class="stats-card" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);">
            ...
            <div class="count">₹ <?php echo number_format($monthlyRevenue); ?></div>
                    ...
                    <?php if (count($recentBookings) > 0): ?>
                      <?php foreach ($recentBookings as $booking):
                        ...
                        <tr>
                          ...
                          <td>
                            <?php echo isset($booking['check_in']) ? date('d M Y', strtotime($booking['check_in'])) : 'N/A'; ?>
                          </td>
                          <td>
                            <?php echo isset($booking['check_out']) ? date('d M Y', strtotime($booking['check_out'])) : 'N/A'; ?>
                          </td>
                          <td>₹<?php echo isset($booking['amount']) ? number_format($booking['amount']) : '0'; ?></td>
                          <td><span
                              class="badge <?php echo $statusClass; ?>"><?php echo isset($booking['status']) ? safeOutput($booking['status']) : 'Unknown'; ?></span>
                          </td>
                        </tr>
                      <?php endforeach; ?>
